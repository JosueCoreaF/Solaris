...
router.put('/hoteles/:id', async (req: Request, res: Response) => {
  try {
    const { id } = req.params;
    const { nombre_hotel, ciudad, direccion, telefono, correo_contacto, estrellas, enlace_google_maps, slug, logo_url, color_primario, color_secundario, redes_sociales } = req.body;
