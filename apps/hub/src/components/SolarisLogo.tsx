...
export default function SolarisLogo({ variant = 'main', size = 40, className, animated = false }: SolarisLogoProps) {
  const gradId = `solaris-grad-${variant}${animated ? '-anim' : ''}`;
            ...
            <>
              <stop offset="0%">
                <animate
                  ...
                  values={`${GRADIENTS.main[0]};${GRADIENTS.hotel[0]};${GRADIENTS.gym[0]};${GRADIENTS.restaurant[0]};${GRADIENTS.main[0]}`}
                  dur="12s"
              ...
              <stop offset="100%">
                <animate
                  attributeName="stop-color"
                  values={`${GRADIENTS.main[1]};${GRADIENTS.hotel[1]};${GRADIENTS.gym[1]};${GRADIENTS.restaurant[1]};${GRADIENTS.main[1]}`}
                  dur="12s"
                  repeatCount="indefinite"
                />
              </stop>
